...
function App() {
  ...
  return (
    <div className="min-h-screen bg-background-dark text-text-light overflow-x-hidden relative">
      {/* Header/Navigation */}
      <header className="fixed top-0 left-0 w-full z-50 glass-dark py-4 px-6 lg:px-16">
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          <div className="flex items-center space-x-4">
            <h1 className="text-2xl lg:text-3xl font-bold tracking-tight cursor-pointer flex items-center"
                onClick={() => scrollToSection('home')}>
              <div className="p-2 bg-gradient-primary rounded-lg mr-3 shadow-glow">
            ...
            <div className="hidden lg:block text-xs text-secondary-400">
      ...
      <section id="about" className="section-padding bg-gradient-dark relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-secondary-500 opacity-10 blur-3xl rounded-full"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
            ...
            <div className="card-modern p-8 group hover:scale-105 transition-all duration-500">
              <div className="flex items-center mb-8">
                ...
                <h3 className="text-4xl font-bold text-gradient">Vision</h3>
              </div>
      ...
      <section id="contribute" className="section-padding bg-gradient-dark relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-secondary-500 opacity-10 blur-3xl rounded-full"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-accent-500 opacity-10 blur-3xl rounded-full"></div>
      ...
      {/* Enhanced Footer */}
      <footer className="py-16 px-8 lg:px-16 bg-gradient-dark border-t border-white/10">
